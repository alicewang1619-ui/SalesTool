    ...
    db.add_all(
        [
            ProductKnowledge(
                ...
                tags=json.dumps(["Portable", "Clinic", "Distributor demo"], ensure_ascii=False),
                version="v1",
                status="active",
                updated_by=admin.id,
            ),
            ProductKnowledge(
                ...
                tags=json.dumps(["Handheld", "Emergency", "Mobile clinic"], ensure_ascii=False),
                version="v1",
                status="active",
                updated_by=admin.id,
            ),
            ProductKnowledge(
                ...
                tags=json.dumps(["Trolley", "Radiology", "Hospital"], ensure_ascii=False),
                version="v1",
                status="active",
                updated_by=admin.id,
            ),
