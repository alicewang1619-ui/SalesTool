...
列表页遵循“筛选区在上，表格为主，详情从列表进入”的模式。线索池列表必须把来源筛选放在筛选区首位，并在表格中露出来源列；来源既支持官网、社媒、邮箱、线下展会等聚合筛选，也支持官网聊天、官网后台、Facebook、领英、邮箱、线下展会导入等具体标签。详情页使用主信息 + 侧栏时间线/状态卡的结构，让 AI 摘要、客户画像、评分理由、分发记录和销售反馈保持同屏可读。
...
徽章用于客户类型、状态、渠道、来源和风险。来源徽章必须显示业务可读的具体来源，如官网聊天、Facebook、领英、邮箱或线下展会导入，不出现技术状态码。
