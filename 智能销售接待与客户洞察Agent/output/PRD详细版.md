...
1. **设置管理必须可理解、可进入、可操作**：设置首页不再只展示“销售账号 / 已启用 / 来源国家映射 / 全局 Banner”等难理解指标；每个指标要有业务解释。8 个设置入口必须真实可点击并有页面或可操作区，覆盖销售账号、角色权限、全局 Banner、国家销售映射、产品知识库、客户来源字典、渠道配置、提醒规则；“最近变更”改为“配置审计记录”，只展示配置相关变更，避免像无用消息流。
