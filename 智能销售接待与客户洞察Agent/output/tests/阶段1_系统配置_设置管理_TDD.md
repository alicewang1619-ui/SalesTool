...
## 2026-07-03 营销技能菜单验收
- SETTINGS-MARKETING-SKILL-01：配置中心顶部 Tab 展示“营销技能”，点击后只展示邮件写手技能配置，不再混在“AI 与模型”中。
- SETTINGS-MARKETING-SKILL-02：AI 与模型 Tab 只包含场景模型绑定、大模型连接配置和产品/AI 配置入口，不渲染“邮件写手角色”卡片。
- SETTINGS-MARKETING-SKILL-03：营销技能 Tab 内可选择默认邮件写手、当前邮件写手，并在右侧技能详情卡查看角色目标、能力方向、执行提示词、技能标签和编辑/删除按钮。
- SETTINGS-MARKETING-SKILL-04：管理员或运营从左侧主导航点击“营销技能”后，应直接进入邮件写手技能配置区；URL 为 `section=marketing` 时左侧高亮“营销技能”、配置中心顶部 Tab 同步高亮“营销技能”，不得显示配置中心总览；销售账号看不到该入口。
